...
//
//    private fun FirDeclarationDesignation.ensureValidPhases() {
//        var currentPhase = FirResolvePhase.RAW_FIR
//        toSequence(includeFile = true, includeTarget = false).forEach {
//            check(currentPhase <= it.resolvePhase) {
//                "Designation declaration have invalid phase. Containing declaration have $currentPhase but child in ${it.resolvePhase}"
//            }
//            currentPhase = it.resolvePhase
//        }
//    }
